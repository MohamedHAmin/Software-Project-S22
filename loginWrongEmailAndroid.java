...
public class loginWrongEmailAndroid {
    AppiumDriver driver;
    // Data for login email and expected toast message.
    private String Email = "abd@gmail.com";
    private String expectedToastMessage = "Sorry, we could not find your account.";
    ...
    public void wrongEmailLogin() throws InterruptedException {
        ...
        WebElement nextGoToPasswordField = (new WebDriverWait(driver,60)).until(ExpectedConditions.presenceOfElementLocated(new By.ByXPath("\t\n" +
