...
function AdminDashboard() {
    ...
    useEffect(() => {
        ...
        axios
        .get(`http://larry-env.eba-u6mbx2gb.us-east-1.elasticbeanstalk.com/api/profile/${userID}/me`, {
      ...
      axios
      .get(`http://larry-env.eba-u6mbx2gb.us-east-1.elasticbeanstalk.com/api/admin/dashboard?duration=${durationText}`, {
      ...
      .then((res) => {
        ...
        if (res.error) {
          console.log("Error");
            ...
            setTweetsPercentage(((Math.abs(res.data.Current.tweetCount-res.data.Past.tweetCount)/res.data.Current.tweetCount)*100).toFixed(2));
            setCommentsPercentage(((Math.abs(res.data.Current.replyCount-res.data.Past.replyCount)/res.data.Current.replyCount)*100).toFixed(2));
            setNewUsersPercentage(((Math.abs(res.data.Current.usersCount-res.data.Past.usersCount)/res.data.Current.usersCount)*100).toFixed(2));
    ...
    return (
        <div className="AdminDashboardPage">
            ...
            <div className="AdminDashboardWholeContainer">
                ...
                <h3 className="DashboardParagraph" >Larry provides insights to help you understand the Larry community as a whole.</h3>
                <h4 className="DashboardParagraph" >Use this data to optimize your future Larry campaigns and get better results.</h4>
                <div className="UsersActivity">
                    <div className="DashboardTextSubtext">
                        <h4 className="DashboardHeader" >Users activity</h4>
                        <div className="DashboardParagraph">{duration} day summary with change over previous period</div>
                    </div>
                    <div className="ButtonsDuration">
                        <Button 
                            onClick={handleClickWeek}
                            className={duration===7?"buttonDurationActive":"buttonDurationStyling" } 
                        >
                            Week
                        </Button>
                        <Button 
                            onClick={handleClickMonth}
                            className={duration===30?"buttonDurationActive":"buttonDurationStyling" } 
                        >
                            Month
                        </Button>
                    </div> 
                ...
                <div className="DashboardCountsContainer">
                    ...
                    <div className="CountBox">
                        ...
                        <div className="CurrentDurationInfo">
                            ...
                            {currentNumNewUsers!==pastNumNewUsers?(currentNumNewUsers>pastNumNewUsers?(
                                <div className="WrapPercentArrowUp">
                                    <span className="ArrowUpDownStyling"><ArrowUpwardIcon/></span>
                                    <span className="PercentUpDownStyling">{newUsersPercentage}%</span>
                                </div>
                            ):(
                                <div className="WrapPercentArrowDown">
                                    <span className="ArrowUpDownStyling"><ArrowDownwardIcon/></span>
                                    <span className="PercentUpDownStyling">{newUsersPercentage}%</span>
                                </div>
                            )):(
                    ...
                    <div className="CountBox">
                        ...
                        <div className="CurrentDurationInfo">
                            ...
                            {currentNumTweets!==pastNumTweets?(currentNumTweets>pastNumTweets?(
                                <div className="WrapPercentArrowUp">
                                    <span className="ArrowUpDownStyling"><ArrowUpwardIcon/></span>
                                    <span className="PercentUpDownStyling">{tweetsPercentage}%</span>
                                </div>
                            ):(
                                <div className="WrapPercentArrowDown">
                                    <span className="ArrowUpDownStyling"><ArrowDownwardIcon/></span>
                    ...
                    <div className="CountBox">
                        ...
                        <div className="CurrentDurationInfo">
                            ...
                            {currentNumComments!==pastNumComments?(currentNumComments>pastNumComments?(
                                <div className="WrapPercentArrowUp">
                                    <span className="ArrowUpDownStyling"><ArrowUpwardIcon/></span>
                                    <span className="PercentUpDownStyling">{commentsPercentage}%</span>
                                </div>
                            ):(
                                <div className="WrapPercentArrowDown">
                                    <span className="ArrowUpDownStyling"><ArrowDownwardIcon/></span>
                    ...
                    <div className="CountBox">
                        ...
                        <div className="CurrentDurationInfo">
                            ...
                            {currentNumRetweets!==pastNumRetweets?(currentNumRetweets>pastNumRetweets?(
                                <div className="WrapPercentArrowUp">
                                    <span className="ArrowUpDownStyling"><ArrowUpwardIcon/></span>
                                    <span className="PercentUpDownStyling">{retweetsPercentage}%</span>
                                </div>
                            ):(
                                <div className="WrapPercentArrowDown">
                                    <span className="ArrowUpDownStyling"><ArrowDownwardIcon/></span>
                        ...
                        <div className="CountBox">
                            <div className="ReportsConatiner">
                                ...
                                <div className="CurrentDurationInfo">
                                    ...
                                    {currentNumReports!==pastNumReports?(currentNumReports>pastNumReports?(
                                        <div className="WrapPercentArrowUp">
                                            <span className="ArrowUpDownStyling"><ArrowUpwardIcon/></span>
                                            <span className="PercentUpDownStyling">{reportsPercentage}%</span>
                                        </div>
                                    ):(
                                        <div className="WrapPercentArrowDown">
                                            <span className="ArrowUpDownStyling"><ArrowDownwardIcon/></span>
