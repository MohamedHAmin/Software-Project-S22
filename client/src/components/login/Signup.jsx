...
const validationSchema1 = Yup.object().shape({
    ...
    email: Yup.string().email('Must be a valid email').max(255).required('Email is required'),
       ...
       ,
    screenName: Yup.string().min(3).required("Write Your screenName"),
    tag:Yup.string().required("Write a tag")
})
    const validationSchema2 = Yup.object().shape({
        ...
        birthDate: Yup.string().required("write a date"),
        Biography: Yup.string().required("write a Biography")
    })
                ...
                <div className={classes.signupContainer}>
                    ...
                    <div className={classes.GoogleLogin}>
...

                        {
                            ...
                            <Form>
                                    <div className={classes.field}>
                                        <Field type="date" name="birthDate" autoComplete="off"></Field>
                                    </div>
