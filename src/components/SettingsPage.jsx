...
function SettingsPage(props) {
  ...
  function onDisplayDarkModeChanged() {  handleChangedDisplayMode();}
  ...
  return (
    <div className='SettingsPage'>
        ...
        <div className="karim">
            <div>
                  <SettingsMenu isDarkMode={isSelectedDarkMode}  onIdChange={onItemSelectedChange}/>
            </div>
            <div className='karim'>
                  {idItemSelected===1&&(<AccountSettings isDarkMode={isSelectedDarkMode}/>) }
                  {idItemSelected===3&&(<PrivacySettings isDarkMode={isSelectedDarkMode}/>) }
                  {idItemSelected===4&&(<NotificationSettings isDarkMode={isSelectedDarkMode}/>) }
                  {idItemSelected===5&&(<DisplaySettings isDarkMode={isSelectedDarkMode} onDarkModeChanged={onDisplayDarkModeChanged}/>) }
            </div>
        </div>  
    </div>  
  );
