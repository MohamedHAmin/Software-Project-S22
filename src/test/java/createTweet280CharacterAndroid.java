...
public class createTweet280CharacterAndroid {
    ...
    public void createTweet280() throws InterruptedException{
        ...
        writeTweet.sendKeys(tweetBody280Character);
        ...
        String validMessage = driver.findElement(MobileBy.xpath(toastMessageXpath)).getText();
        System.out.println(validMessage);
        // Check if the printed message matches the expected one.
        if(validMessage.equalsIgnoreCase(expectedMessageCreateTweet)) {
