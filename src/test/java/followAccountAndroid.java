...
public class followAccountAndroid  {
    AppiumDriver driver;
    @BeforeTest
    ...
    @Test
    public void followAccount() throws InterruptedException {
...
//        touchAction.tap(PointOption.point(120, 876)).perform();
        // Check
        Thread.sleep(3000);
        touchAction.tap(PointOption.point(412, 1845)).perform();
        Thread.sleep(5000);
        ...
        elementToClick = (MobileElement) driver.findElement(new MobileBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector()"
                ...
                + "new UiSelector().text(\"Farah Gamal\"));"));
