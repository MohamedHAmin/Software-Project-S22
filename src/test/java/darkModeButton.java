...
public class darkModeButton {
    ...
    public void darkMode() throws InterruptedException {
        ...
        WebElement accessibility = (new WebDriverWait(driver, 60)).until(ExpectedConditions.presenceOfElementLocated(new By.ByXPath(accessibilityXpath)));
        accessibility.click();
        // Find the display option then click on it.
        WebElement display = (new WebDriverWait(driver, 60)).until(ExpectedConditions.presenceOfElementLocated(new By.ByXPath(displayXpath)));
        display.click();
        // Find the dark mode option then click on it.
        WebElement darkMode = (new WebDriverWait(driver, 60)).until(ExpectedConditions.presenceOfElementLocated(new By.ByXPath(darkModeXpath)));
        darkMode.click();
        // Find dark mode choice then click on it.
        WebElement turnOn = (new WebDriverWait(driver, 60)).until(ExpectedConditions.presenceOfElementLocated(new By.ByXPath(turnOnXpath)));
        turnOn.click();
...
//        String c = Color.fromString(cssProperty).asHex();
//        System.out.println(c);
    ...
    public void tearDown() throws InterruptedException {
        ...
        WebElement backToDisplay = (new WebDriverWait(driver, 60)).until(ExpectedConditions.presenceOfElementLocated(new MobileBy.ByAccessibilityId(navigateUpId)));
        backToDisplay.click();
        Thread.sleep(2000);
        // Find the back icon then click on it.
        WebElement backToAccessibility = (new WebDriverWait(driver, 60)).until(ExpectedConditions.presenceOfElementLocated(new MobileBy.ByAccessibilityId(navigateUpId)));
        backToAccessibility.click();
        Thread.sleep(2000);
        // Find the back icon then click on it.
        WebElement backToSettings = (new WebDriverWait(driver, 60)).until(ExpectedConditions.presenceOfElementLocated(new MobileBy.ByAccessibilityId(navigateUpId)));
