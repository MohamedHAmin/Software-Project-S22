...
public class settingBackButtonAndroid {
    AppiumDriver driver;
    ...
    @Test
    public void settingBackButton() throws InterruptedException {

        // Wait till the home page appear.
        Thread.sleep(2000);
        // Find the profile icon then click on it.
        ...
        WebElement backIcon = (new WebDriverWait(driver,60)).until(ExpectedConditions.presenceOfElementLocated(new MobileBy.ByAccessibilityId("Navigate up")));
        backIcon.click();
        // Check if it redirects you to the home page or not.
