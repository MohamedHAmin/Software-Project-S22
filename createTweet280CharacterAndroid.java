...
public class createTweet280CharacterAndroid {
    AppiumDriver driver;
    // Tweet body and teh expected toast message when the tweet appear successfully.
    //
    private String tweetBody = "Life is hard. Even if people always have a positive outlook, work hard, and keep their heads up, life can still get them down. It's inevitable. Sometimes, when people feel miserable or sad, all it takes to turn a bad day or a bad moment around is a great quote.                   ";
    private String expectedMessage = "Sending Tweet…";
    ...
    // Test case for empty tweet.
    @Test
    public void createTweet280() throws InterruptedException{
