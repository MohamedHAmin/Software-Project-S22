...
public class SignupPasswordLessThan6 {
    AppiumDriver driver;
    ...
    public void signup() throws InterruptedException {
        ...
        createAccount.click();
        Thread.sleep(2000);
        if(driver.findElement(By.xpath(passwordErrorMessageLessThan6)).isDisplayed()){
