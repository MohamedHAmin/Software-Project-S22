...
public class SignupPasswordBetween1013 {
    AppiumDriver driver;
    ...
    public void signup() throws InterruptedException {
        ...
        createAccount.click();
        Thread.sleep(3000);
        if(driver.findElement(By.xpath(passwordErrorMessageAverage)).isDisplayed()){
