...
public class spaceALL {
    ...
    public void signup() throws InterruptedException {
        ...
        createAccount.click();
        Thread.sleep(2000);
        if(driver.findElement(By.xpath(usernameErrorMessage)).isDisplayed()){
