...
public class SignupPasswordMoreThan16 {
    AppiumDriver driver;
    ...
    public void signup() throws InterruptedException {
        ...
        password.click();
        Thread.sleep(2000);
        password.sendKeys(passwordMoreThan16);
        ...
        Thread.sleep(2000);
        confirmPassword.sendKeys(passwordMoreThan16);
        ...
        createAccount.click();
        Thread.sleep(3000);
        if(passwordCheck.equalsIgnoreCase(passwordEqualsTo16)){
