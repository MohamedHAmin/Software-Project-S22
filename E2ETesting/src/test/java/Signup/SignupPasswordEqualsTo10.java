...
public class SignupPasswordEqualsTo10 {
    AppiumDriver driver;
    ...
    public void signup() throws InterruptedException {
        ...
        createAccount.click();
        Thread.sleep(2000);
        if(driver.findElement(By.xpath(passwordErrorMessageWeak)).isDisplayed()){
