...
public class delete {
    ...
    public void notification() throws InterruptedException {
        WebElement icon = driver.findElement(new By.ByXPath(notificationIcon));
        icon.click();
        Thread.sleep(2000);
        TouchAction touchAction=new TouchAction(driver);
        touchAction.tap(PointOption.point(1002, 272)).perform();
        Thread.sleep(2000);
        WebElement home = driver.findElement(new By.ByXPath(homeIconNotification));
        home.click();
        Thread.sleep(2000);
        WebElement back = driver.findElement(new By.ByXPath(notificationIcon));
        back.click();
        Thread.sleep(2000);
    }
