...
import static variabales.selectors.searchField;
...
public class searchFollowing {
    ...
    public void notification() throws InterruptedException {
        WebElement search = driver.findElement(new By.ByXPath(searchOption));
        search.click();
        Thread.sleep(2000);
        WebElement field = driver.findElement(new By.ByXPath(searchField));
        field.click();
        Thread.sleep(2000);
        field.sendKeys("admintag1");
        Thread.sleep(3000);
        TouchAction touchAction=new TouchAction(driver);
        touchAction.tap(PointOption.point(114, 354)).perform();
        Thread.sleep(4000);
