...
public class anotherUserTextTextText {
    AppiumDriver driver;
    ...
    public void Retweet() throws InterruptedException {
        WebElement retweet = driver.findElement(new By.ByXPath(secondRetweetImageNoNo));
        retweet.click();
        Thread.sleep(2000);
        WebElement write = driver.findElement(By.xpath(editLine)) ;
        write.click();
        Thread.sleep(2000);
        write.sendKeys(retweetBody);
        ...
        post.click();
        Thread.sleep(3000);
        if (driver.findElement(By.xpath(testTweet)).isDisplayed()){
